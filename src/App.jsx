    ...
    <div style={{display:"flex",gap:6,alignItems:"center",width:"100%"}}>
      ...
      <div style={{position:"relative",flex:"1 1 0%",minWidth:0,display:"flex"}}>
        <input
          ...
          style={{background:"#DDE3EC",border:"1px solid #C8CEDB",color:"#15233F",padding:"0 24px 0 10px",height:28,fontFamily:FONT,fontSize:12,borderRadius:4,width:"100%",minWidth:0,boxSizing:"border-box"}}
        />
        {evSearch && (
      ...
      <select value={evTypeFilter} onChange={e=>setEvTypeFilter(e.target.value)}
        style={{background:"#DDE3EC",border:"1px solid #C8CEDB",color:"#8A94A8",padding:"0 8px",height:28,boxSizing:"border-box",fontFamily:FONT,fontSize:12,borderRadius:4,flexShrink:0}}>
