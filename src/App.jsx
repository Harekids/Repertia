            ...
            <div style={{display:"flex",flexDirection:"column",gap:16}}>
              ...
              {(profile.teachers||[]).map((t,idx)=>(
                <div key={t.id} style={{display:"flex",alignItems:"center",gap:6}}>
                  <div style={{fontSize:11,color:"#6A5030",fontFamily:SANS,width:130,flexShrink:0}}>{idx===0?"師事者":""}</div>
          ...
          <div style={{maxWidth:680,margin:"0 auto",display:"flex",flexDirection:"column",gap:20}}>
            ...
            <div style={{background:"#F8F4EE",border:"1px solid #E8E0D0",borderRadius:8,padding:"14px 16px"}}>
              ...
              <div style={{display:"flex",gap:16,flexWrap:"wrap",justifyContent:"center"}}>
                <button onClick={()=>{const w=window.open("","_blank");const html=outText.split("\n").join("<br>");w.document.write("<html><body style='font-family:serif;padding:40px;line-height:1.9;color:#2A2010'>"+html+"</body></html>");w.document.close();w.print();}}
