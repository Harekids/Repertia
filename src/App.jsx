  ...
  return (
    <div style={{
      ...
      <div style={{padding:"10px 12px 8px 13px",display:"flex",alignItems:"center",gap:6,cursor:"pointer"}}
        ...
        {p.fav && <span style={{flexShrink:0,fontSize:13,lineHeight:1,width:16,height:16,display:"inline-flex",alignItems:"center",justifyContent:"center",color:"#C0405A",marginRight:4}} title="お気に入り">♥</span>}
        {showControls && (
